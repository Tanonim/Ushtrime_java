...
for (int j =0; j<list2.size(); j++) {
	System.out.println(obj2.getRandomList(list2));
}
Ushtrimi7 obj3 = new Ushtrimi7();
for (int k=0; k<list3.size(); k++) {
	System.out.println(obj3.getRandomList(list3));
}
Ushtrimi7 obj4 = new Ushtrimi7();
for (int l=0; l<list4.size(); l++) {
	System.out.println(obj4.getRandomList(list4));
}
Ushtrimi7 obj5 = new Ushtrimi7();
for (int m=0; m<list5.size(); m++) {
	System.out.println(obj5.getRandomList(list5));
}
